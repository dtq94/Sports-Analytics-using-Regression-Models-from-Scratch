...
class RegressionTree:
    ...
    def best_split_calculator(self):
        ...
        for feature in self.features:
            X_df = df.dropna().sort_values(feature) #sort to calculate moving avg (consecutive values)
...
if __name__ == '__main__':
    ...
    root_node = RegressionTree(X_train, y_train, maxm_depth=2, min_split=3) #each node should have 3 data points atleast (min_split)
    root_node.RT_main()
